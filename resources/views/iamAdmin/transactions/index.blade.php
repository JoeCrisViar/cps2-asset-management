            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0">Transactions</h4>
                </div>
                <div class="card-body">
                  <!-- Loop Here -->
                   ...
                   <div class="card">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-lg-2 offset-lg-2"><a href="#">Manage</a></div>
                      </div>
                      <hr>
                      @php
                      ...
                      @endphp
                        ...
                        @endforeach
                        <div class="col-md-4">Buyer: Buyer01</div>
                        <div class="col-md-4">Seller: Seller01</div>
                    </div>
                  </div>
                  @empty
